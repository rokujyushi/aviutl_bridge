  ...
  case $1 in
    ...
    -a|--arch)
      if [[ "$2" != "i686" && "$2" != "x86_64" ]]; then
        echo "Error: --arch must be either 'i686' or 'x86_64'"
        exit 1
      fi
      ARCH="$2"
      shift 2
...
CMAKE_C_COMPILER=${CMAKE_C_COMPILER:-${ARCH}-w64-mingw32-clang}
CMAKE_TOOL_CHANIN_FILE=${CMAKE_TOOL_CHANIN_FILE:-"llvm-mingw.cmake"}
